...
const InfoCard = ({size, icon, name, description}:InfoCardsPropsType) => {
    return (
        <div className={`flex flex-col items-center gap-4 min-h-[300px] min-w-[230px] xl:min-h-[220px] xl:min-w-[410px] justify-center p-6 bg-[#f3fefe] rounded-2xl shadow-lg ${size === 'large' ? 'w-72' : 'w-48'} -mt-3 mb-6`}>
